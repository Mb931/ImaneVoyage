...
<html>
	...
	<body>
		...
		// récupération du nombre de lignes traitées - dans le cas où on est après une insertion
			...
			<br>Vous disposez maintenant de votre espace personnel nous vous invitons à vous diriger vers la page d'acceuil pour vous connecter et accéder a votre compte.<br /></p>";
		?>
		 <!-- Lien pour retourner à la page initiale -->
		 <br>
		 <br>
		 <ul>
		 <li><a href="espacepersonnel.php">Retour accueil</a></li>
		 </ul>
	</body>
</html>

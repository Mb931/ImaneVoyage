...
{
	$message_erreur="ATTENTION : Le champ nom, prenom ou motdepasse  n'a pas été rempli correctement, veuillez vérifier";
...
else // $nom et $prenom sont corrects  
{
	...
	if($nb_lignes > 0) // on a inséré 1 ligne
	{
		...
		header("Location: menu.php"); // page de confirmation

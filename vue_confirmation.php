...
<html>
	...
	<body>
		...
		// récupération du nombre de lignes traitées - dans le cas où on est après une insertion
			...
			<br>Vous disposez maintenant de votre espace abonné nous vous invitons à vous diriger vers la page d'acceuil pour vous connecter pour accédez a votre espace<br /></p>";
		?>

...
<html>
	...
	<body>
		...
		// récupération du nombre de lignes traitées - dans le cas où on est après une insertion
			...
			<br>Ce projet vous est présenté par Ba Murtudo, Lupini Joady et Sow Amadou nous vous conseillons de bien attacher votre ceinture bon voyage. Vous pouvez maintenant accéder au projet SIG.<br /></p>";
		?>
